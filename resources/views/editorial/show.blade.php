        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex gap-3">
                    <form action="{{ route('editorial.upvote', $editorial->editorial_id) }}" method="POST" style="display: inline;">
                        @csrf
                    ...
                    <form action="{{ route('editorial.downvote', $editorial->editorial_id) }}" method="POST" style="display: inline;">
                        @csrf
                ...
                <div>
                    @if(auth()->check() && (auth()->id() === $editorial->author_id || auth()->user()->role === 'admin'))
                        <a href="{{ route('editorial.edit', $editorial->editorial_id) }}" class="btn btn-warning">
                            <i class="fas fa-edit"></i> Edit Editorial
                        </a>
                    @endif
                    
                    @if(auth()->check() && auth()->user()->role === 'admin')
                        <form action="{{ route('editorial.destroy', $editorial->editorial_id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
    ...
    <div class="row mt-4 pt-4" style="border-top: 2px solid #dee2e6;">
        <div class="col-12">
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('editorial.index') }}" class="btn btn-secondary">
